...
public class My_SreenShot {
	...
	public static Object screenshot() throws Throwable {
	    ...
	    System.out.println("Capture d'écran réalisée......"+MyKeyWord.extractCurrentDate()+" à "+MyKeyWord.extractCurrentHeure());
	    ...
	    System.out.println("Création du fichier : capture d'écran (index "+i+")......"+MyKeyWord.extractCurrentDate()+" à "+MyKeyWord.extractCurrentHeure());
